...
FLEX_BIN  =  'flex'
FLEX_OPTS =  '--header-file=src/phases/parse/lexer/lex.yy.h'
FLEX_IN   =  'src/phases/parse/lexer/lexer.l'
FLEX_OUT  =  'src/phases/parse/lexer/lex.yy.c'

BISON_BIN  = 'bison'
BISON_OPTS = '-d'
BISON_IN   = 'src/phases/parse/grammar/grammar.y'
BISON_OUT  = 'src/phases/parse/grammar/grammar.tab.c'
...
SRC_FILES    = (FileList['src/**/*.c'] + [ BISON_OUT, FLEX_OUT ]).uniq
